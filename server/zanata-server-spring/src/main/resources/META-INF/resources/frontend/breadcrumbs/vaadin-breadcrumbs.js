...
// Local patch (alpha5): the installed I18nMixin uses the older
// curried signature `(defaultI18n, superClass)`. Adapt our usage to match.
import { ResizeMixin } from '@vaadin/component-base/src/resize-mixin.js';
// Use a local shim — alpha5's stock SlotObserver has the older single-slot
// signature and crashes on shadowRoot. See local-slot-observer.js.
import { SlotObserver } from './local-slot-observer.js';
...
class Breadcrumbs extends KeyboardDirectionMixin(
  ResizeMixin(I18nMixin(DEFAULT_I18N, ElementMixin(PolylitMixin(LumoInjectionMixin(LitElement))))),
) {
  static get is() {
