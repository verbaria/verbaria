 ...
 *
 *
 *      Property which has {@link jakarta.persistence.OneToMany#mappedBy()} or
 *      {@link jakarta.persistence.OneToOne} in field or GetterMethod
...
public class JPACopier {
     ...
     * {@link jakarta.persistence.OneToMany#mappedBy()}
